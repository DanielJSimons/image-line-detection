...
def process_test_set(MIN_LEN=image_preprocessing.MIN_LEN, DEG=image_preprocessing.DEG, MAX_R=image_preprocessing.MAX_R, HOUGH_THRES=image_preprocessing.HOUGH_THRES, HOUGH_POINTS=image_preprocessing.HOUGH_POINTS):
# Set up a 2x9 grid
    ...
    for i in range(1, 9):
        # Load the image
        image_path = f"Images//line_detection_table{i}.jpg"
